...
fp_hab_sat <- here("spatial_data/hab_satellite_2021-07-29.tif")
...
sf_ca_bound <-
  read_sf(here("spatial_data/CA_State_TIGER2016.shp")) %>%
...
sf_ow_delta <- read_sf(here("spatial_data/Franks_Mildr_CCF_LibIsl.shp")) %>% 
  rename(Region = HNAME) %>% 
  st_transform(crs = st_crs(strs_hab_sat_c))
...
Each row represents a pixel either completely or partially within the polygon for Franks Tract.
...
knitr::include_graphics("images/SFEI_HAB_Satellite_pixel_values.jpg")
```
